...
<div class="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-indigo-900 via-purple-900 to-cyan-900 relative overflow-hidden">
    ...
    <div class="w-full max-w-2xl p-8 rounded-3xl backdrop-blur-2xl bg-white/10 border border-white/20 shadow-2xl flex flex-col gap-8">
        <h2 class="text-3xl font-bold text-white flex items-center gap-2">
            <svg class="w-8 h-8 text-indigo-400 drop-shadow" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M4 4h16v16H4z"/><path d="M8 2v4m8-4v4"/></svg>
            Document Vault
        </h2>
        <!-- Upload Portal -->
        <form class="flex flex-col gap-4">
            <label class="block text-white/80 font-semibold">Upload Document</label>
        ...
        <div class="mt-6">
            <h3 class="text-xl font-semibold text-white/90 mb-2">Your Documents</h3>
            <div class="rounded-xl bg-white/10 border border-white/20 p-4 text-white/80 shadow-inner min-h-[80px]">
                <em>Uploaded documents will appear here...</em>
            </div>
        </div>
    </div>
