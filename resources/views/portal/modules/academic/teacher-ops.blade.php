    <section id="teacher-ops" class="module-card module-students glass p-3 p-lg-4 mb-4 fade-up" style="animation-delay: 0.31s;">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h2 class="h4 section-title mb-0">Teacher Operations</h2>
