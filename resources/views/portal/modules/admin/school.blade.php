<section id="school-module" class="glass-card p-4 mb-4 fade-up" style="animation-delay: 0.29s;">
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
        <div>
            <h2 class="h4 section-title mb-1">School Module</h2>
        ...
        <div class="col-lg-6">
            <div class="p-3 rounded-4 border h-100">
                ...
                @if($currentUser->role === 'superadmin')
                    <p class="mb-0">You are in global scope and can manage all schools.</p>
                @else
